...
model.save('./saveModel/GRU_classification.h5')
# print(model.summary())
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('./saveImage/GRU/train_loss.png', dpi=300)
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('./saveImage/GRU/acc.png', dpi=300)
# plt.show()
...
plt.savefig('./saveImage/GRU/ROC.png', dpi=300)
# plt.show()
...
plt.savefig('./saveImage/GRU/Result.png', dpi=300)
# plt.show()
for key in result:
...
plt.savefig('./saveImage/GRU/confusion_matrix')
# plt.show()
...
plt.title('Some extension of Receiver operating characteristic to multi-class')
plt.legend(loc="lower right")
plt.savefig('./saveImage/GRU/Result_0_1.png', dpi=300)
